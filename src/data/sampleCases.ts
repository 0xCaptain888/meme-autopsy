...
export const archivedCases: ArchivedCaseFile[] = [
  {
    key: "BananaFax",
    specimenLabel: "TERMINAL SPECIMEN",
  ...
  {
    key: "DogePriest",
    specimenLabel: "OPEN EXAMINATION",
    condition: "Viral but Fragile",
  ...
  {
    key: "SaintMeme",
    specimenLabel: "PRESERVED SPECIMEN",
    condition: "Stable Cult Potential",
