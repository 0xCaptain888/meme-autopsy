...
const translations: TranslationDict = {
  ...
  "intake.projectName": { en: "Project Name", zh: "项目名称" },
  "intake.chain": { en: "Chain", zh: "链" },
  ...
  "intake.caseAccepted": { en: "Case Accepted", zh: "案件已受理" },
  "intake.specimenLogged": { en: "Specimen Logged", zh: "标本已登记" },
  "intake.validating": { en: "Validating specimen identity...", zh: "验证标本身份..." },
  "intake.registering": { en: "Registering case...", zh: "登记案件中..." },
  "intake.evidenceChecklist": { en: "Evidence Sources to Secure", zh: "待获取的证据来源" },
