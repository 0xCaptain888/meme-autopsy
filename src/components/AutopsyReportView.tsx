...
import StageOfDecayBlock from "./report/StageOfDecayBlock";
import DegenerationTimeline from "./report/DegenerationTimeline";
    ...
    <div className="h-full overflow-y-auto pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-6">
          ...
          {/* 11. Stage of Decay */}
          <StageOfDecayBlock
            stageOfDecay={report.stageOfDecay}
            estimatedFailureWindow={report.estimatedFailureWindow}
          />

          {/* 11b. Degeneration Timeline */}
          {report.degenerationTimeline && report.degenerationTimeline.length > 0 && (
            <DegenerationTimeline events={report.degenerationTimeline} />
          )}
